...
export default function CodexDetail() {
  ...
  if (!slugStr) return <p className="text-white p-10">Loading sacred scroll...</p>;
      ...
      <main className={`flex-1 p-8 ${shareTech.className} overflow-auto`}>
        ...
        >
          ...
          <section className="mb-6">
            <h2 className="text-xl text-red-500 underline underline-offset-4 mb-2">🧠 Why Use It</h2>
            <p className="whitespace-pre-line text-gray-300">{data.why}</p>
          </section>

          <section className="mb-6">
            <h2 className="text-xl text-red-500 underline underline-offset-4 mb-2">✅ Good / Bad Example</h2>
          ...
          <section>
            <h2 className="text-xl text-red-500 underline underline-offset-4 mb-2">⚠️ When Not to Use</h2>
            <p className="whitespace-pre-line text-gray-300">{data.whenNot}</p>
          </section>

          <div className="mt-10 text-center">
            <Link href="/">
              <span className="text-red-300 hover:text-white underline cursor-pointer">⬅ Return to Codex</span>
            </Link>
          </div>
        </motion.div>
      </main>
